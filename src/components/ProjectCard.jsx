...
const ProjectCard = () => {
  return (
    <div className='w-96 rounded-md h-fit overflow-hidden shadow-md shadow-zinc-900 bg-slate-700'>
      <img src={WeatherApp} alt='' className='hover:scale-110 transition' />
      <div className='p-4'>
        <h1 className='text-3xl text-left my-4'>React Weather App</h1>
        <p>
          Yet another Weather App with React and Tailwind CSS, using{' '}
          <a href='https://openweathermap.org' className='text-pink-500'>
            openweathermap
          </a>{' '}
          API. Features: Different units for tempratures, Geolocation, Multiple
        ...
        <a
          ...
          className='inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-pink-600 rounded-lg hover:bg-pink-600 hover:border-pink-600 md:text-2xl hover:shadow-xl hover:shadow-pink-600/50 focus:ring-4 focus:outline-none focus:ring-pink-300 my-3'
        >
          Live Demo
          <svg
            className='ml-2'
        ...
        <a
          href='https://github.com/syzgod/weather-app-to-portfolio'
          className='inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-pink-600 rounded-lg hover:bg-pink-600 hover:border-pink-600 md:text-2xl hover:shadow-xl hover:shadow-pink-600/50 focus:ring-4 focus:outline-none focus:ring-pink-300 my-3 ml-3'
        >
          Code
          <svg
            aria-hidden='true'
